...
| REQ-004 | PHASE-001 | TICKET-008, TICKET-009, TICKET-012 | Generated wiki claims have typed evidence, confidence, WikiPlan page ownership models, canonical starter evidence pages, and semantic source evidence snapshots | yes | yes | not_required | not_required | yes | yes | in_progress | `rtk cargo test -p codewiki-explore -p codewiki-docs -p codewiki-core`; `rtk cargo test -p codewiki-store -p codewiki-core -p codewiki-detect -p codewiki-docs`; `rtk cargo test -p codewiki-docs -p codewiki-core -p codewiki-store -p codewiki-detect`; `docs/work/tickets/TICKET-008-wikiplan-evidence-models.md`; `docs/work/tickets/TICKET-009-canonical-docs-generator.md`; `docs/work/tickets/TICKET-012-semantic-exploration-v1.md` |
