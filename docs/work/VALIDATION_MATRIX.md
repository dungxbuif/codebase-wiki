...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| REQ-001 | PHASE-001 | TBD | `codewiki init` automatically explores a repository and produces an evidence-backed WikiPlan without approval gates | no | no | no | no | no | no | planned | none |
...
| REQ-003 | PHASE-001 | TICKET-003, TICKET-004 | CodeWiki has deterministic committed config/plan/AGENTS skeleton and versioned durable SQLite state migrations | yes | not_required | not_required | not_required | yes | yes | implemented | `rtk cargo test`; `rtk cargo test -p codewiki-store`; `docs/work/tickets/TICKET-003-config-storage-skeleton.md`; `docs/work/tickets/TICKET-004-sqlite-state-migrations.md` |
