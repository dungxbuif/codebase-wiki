...
| REQ-004 | PHASE-001 | TICKET-008, TICKET-009 | Generated wiki claims have typed evidence, confidence, WikiPlan page ownership models, and canonical starter evidence pages | yes | yes | not_required | not_required | yes | yes | in_progress | `rtk cargo test -p codewiki-store -p codewiki-core -p codewiki-detect -p codewiki-docs`; `rtk cargo test -p codewiki-docs -p codewiki-core -p codewiki-store -p codewiki-detect`; `docs/work/tickets/TICKET-008-wikiplan-evidence-models.md`; `docs/work/tickets/TICKET-009-canonical-docs-generator.md` |
...
| REQ-011 | PHASE-001 | TICKET-011 | CodeWiki supports repo-local/external wiki placement and user-provided non-Git source extension skills while Git remains the default source | yes | not_required | not_required | not_required | not_required | yes | implemented | `rtk cargo test -p codewiki-store`; `skill/codewiki/references/workspace-placement.md`; `skill/codewiki/references/source-extensions.md`; `docs/decisions/ADR-0006-workspace-placement-and-source-extension-skills.md` |
