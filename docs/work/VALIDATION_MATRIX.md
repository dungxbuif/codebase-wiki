...
| REQ-004 | PHASE-001 | TICKET-008 | Generated wiki claims have typed evidence, confidence, and WikiPlan page ownership models | yes | not_required | not_required | not_required | no | yes | in_progress | `rtk cargo test -p codewiki-store -p codewiki-core -p codewiki-detect -p codewiki-docs`; `docs/work/tickets/TICKET-008-wikiplan-evidence-models.md` |
