...
| REQ-009 | PHASE-001 | TICKET-020, TICKET-022, TICKET-025 | CodeWiki writes generated wiki pages directly under `docs/` using OpenWiki-style quickstart/section directories and DeepWiki-style relevant-source page context while `.agents/skills/codewiki/project/**` remains the committed control plane | yes | yes | not_required | not_required | not_required | yes | implemented | `rtk cargo test`; `rtk cargo run -p codewiki-cli -- init /private/tmp/codewiki-agent-control-smoke`; `rtk proxy test ! -e /private/tmp/codewiki-agent-control-smoke/.codewiki`; `docs/decisions/ADR-0005-codewiki-generated-docs-structure.md`; `skill/codewiki/SKILL.md`; `skill/codewiki/references/docs-structure.md`; `docs/architecture/ARCHITECTURE.md`; `docs/work/tickets/TICKET-020-direct-docs-root-and-skill-helper.md`; `docs/work/tickets/TICKET-022-openwiki-deepwiki-docs-patterns.md`; `docs/work/tickets/TICKET-025-agent-workspace-control-plane.md` |
...
| REQ-012 | not_applicable | TICKET-027 | CodeWiki generates a canonical conventions page and requires evidence-derived project, language, framework/library, and area conventions with explicit/inferred/hypothesis/exception classification | yes | yes | not_required | not_required | yes | yes | implemented | `rtk cargo test` (38 tests, 14 suites); init smoke under `/private/tmp/codewiki-conventions-smoke.5AE7jG`; `skill/codewiki/references/conventions.md`; `docs/work/tickets/TICKET-027-code-conventions-documentation.md`; `docs/decisions/ADR-0008-code-conventions-documentation.md` |
