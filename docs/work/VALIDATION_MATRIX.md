...
| REQ-003 | PHASE-001 | TICKET-003 | CodeWiki has deterministic committed config/plan/AGENTS skeleton and planned durable local state layout | yes | not_required | not_required | not_required | yes | yes | in_progress | `rtk cargo test`; `docs/work/tickets/TICKET-003-config-storage-skeleton.md` |
