...
| 3 | BL-003 | architecture | high-risk | Specify config, storage, cache, and migration model | High | in_progress | `docs/work/tickets/TICKET-003-config-storage-skeleton.md`, `docs/work/tickets/TICKET-004-sqlite-state-migrations.md`, `docs/decisions/ADR-0001-codewiki-core-tooling-and-state.md` | Data model, Runtime, Existing behavior | SQLite executor and path resolver | Config/plan/AGENTS skeleton and initial SQLite schema migration exist; executor/path resolver remain. |
