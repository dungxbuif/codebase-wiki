...
| 3 | BL-003 | architecture | high-risk | Specify config, storage, cache, and migration model | High | in_progress | `docs/work/tickets/TICKET-003-config-storage-skeleton.md`, `docs/decisions/ADR-0001-codewiki-core-tooling-and-state.md` | Data model, Runtime, Existing behavior | SQLite schema/migrations detail design | Config/plan/AGENTS skeleton exists; SQLite migrations remain. |
