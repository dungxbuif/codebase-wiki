...
| 18 | BL-018 | phase + bugs | high-risk | Deliver reader-first developer-onboarding documentation quality | High | in_review | `docs/work/phases/PHASE-002-reader-first-docs-quality.md`, `docs/work/benchmarks/MEZON-DESKTOP-9D7BA65.md`, `docs/work/bugs/BUG-001-companion-bypasses-reader-synthesis.md`, `docs/work/bugs/BUG-002-installed-skill-version-drift.md`, `docs/work/bugs/BUG-003-skill-can-bypass-init-gate.md`, `docs/work/bugs/BUG-004-installed-skill-self-contaminates-source-discovery.md`, `docs/work/research/READER-FIRST-DOCS-AUDIT.md`, `docs/work/research/REFERENCE-DOCS-QUALITY-RESEARCH.md`, `docs/work/research/GROK-WIKI-MEZON-AUDIT.md`, `docs/work/tickets/TICKET-029-wikiplan-v2-topic-taxonomy.md`, `docs/work/tickets/TICKET-030-reader-first-synthesis-and-diagrams.md`, `docs/work/tickets/TICKET-031-onboarding-quality-evals.md` | Public contract/API, Existing behavior, Weak proof, Multi-domain, Standards change | human UAT + broader benchmark comparison | Package 0.2.2 makes current working tree the init source of truth, hardens reader/eval contracts, and prevents the installed CodeWiki payload from contaminating target detection/evidence; broader UAT/comparison remains. |
| 19 | BL-019 | feature + correctness | high-risk | Expose deterministic SQLite retrieval and harden claim freshness | High | done | `docs/work/tickets/TICKET-035-sqlite-retrieval-surface-v2.md`, `docs/work/designs/DESIGN-035-sqlite-retrieval-surface-v2.md`, `docs/work/verifications/TEST-035-sqlite-retrieval-surface-v2.md` | Public contract/API, Runtime, Existing behavior, Weak proof | done | Package 0.3.0 exposes local memory without direct SQL, broadens bounded lookup, hardens freshness, removes legacy area claims, and preserves state identity across lexical path aliases. |
