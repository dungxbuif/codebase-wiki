...
| 4 | BL-004 | architecture | high-risk | Define semantic exploration and evidence model | High | in_progress | `docs/requirements/SPEC.md`, `docs/work/tickets/TICKET-007-repo-detection-v1.md`, `docs/work/tickets/TICKET-008-wikiplan-evidence-models.md` | Public contract/API, External system/provider, Multi-domain | source-backed docs generation | Detection v1 and WikiPlan/evidence/claim models exist; source-backed docs generation remains. |
