...
| 4 | BL-004 | architecture | high-risk | Define semantic exploration and evidence model | High | in_progress | `docs/requirements/SPEC.md`, `docs/work/tickets/TICKET-007-repo-detection-v1.md` | Public contract/API, External system/provider, Multi-domain | WikiPlan v1 + evidence models | Detection v1 exists; WikiPlan, claims, evidence, hypotheses, and confidence model remain. |
