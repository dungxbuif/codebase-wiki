...
| 4 | BL-004 | architecture | high-risk | Define semantic exploration and evidence model | High | in_progress | `docs/requirements/SPEC.md`, `docs/work/tickets/TICKET-007-repo-detection-v1.md`, `docs/work/tickets/TICKET-008-wikiplan-evidence-models.md`, `docs/work/tickets/TICKET-009-canonical-docs-generator.md`, `docs/work/tickets/TICKET-012-semantic-exploration-v1.md`, `docs/work/tickets/TICKET-013-claim-persistence-v1.md` | Public contract/API, External system/provider, Multi-domain | deeper synthesis + staleness | Detection, WikiPlan/evidence/claim models, canonical starter docs, semantic exploration v1, and durable claim persistence exist; deeper claim synthesis/staleness remains. |
