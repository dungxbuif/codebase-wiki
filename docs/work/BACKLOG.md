...
| 4 | BL-004 | architecture | high-risk | Define semantic exploration and evidence model | High | in_progress | `docs/requirements/SPEC.md`, `docs/work/tickets/TICKET-007-repo-detection-v1.md`, `docs/work/tickets/TICKET-008-wikiplan-evidence-models.md`, `docs/work/tickets/TICKET-009-canonical-docs-generator.md` | Public contract/API, External system/provider, Multi-domain | semantic exploration + claim persistence | Detection, WikiPlan/evidence/claim models, and canonical starter docs exist; deeper semantic exploration remains. |
